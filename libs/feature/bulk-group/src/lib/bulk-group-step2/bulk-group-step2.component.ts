...
@Component({
  selector: 'fan-id-bulk-group-step2',
  templateUrl: './bulk-group-step2.component.html',
  styleUrls: ['./bulk-group-step2.component.scss'],
})
export class BulkGroupStep2Component implements OnInit,AfterViewInit,OnDestroy {
